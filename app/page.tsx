...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] flex flex-col font-sans selection:bg-gray-200">
      <AuthRedirectGuard />
      {/* Simple Header */}
      <header className="h-20 flex items-center justify-between px-8 max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center gap-6">
          ...
          <Link href="/signup" className="px-6 py-2.5 bg-gray-900 text-white rounded-xl text-sm font-bold shadow-lg shadow-gray-900/20 hover:bg-gray-800 active:scale-95 transition-all">
            无料で始める
          </Link>
        </div>
      </header>
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center max-w-4xl mx-auto py-20">
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 rounded-full mb-8 border border-gray-200 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <span className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-600">プライベートベータ公開中</span>
        </div>
        ...
        <h1 className="text-5xl md:text-7xl font-black text-gray-900 leading-[1.1] mb-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
          インスタグラム成長を <br />
          <span className="bg-gradient-to-r from-gray-900 via-gray-600 to-gray-900 bg-clip-text text-transparent">自動化しよう</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 animate-in fade-in slide-in-from-bottom-16 duration-700 delay-300">
          <Link href="/signup" className="group px-8 py-4 bg-gray-900 text-white rounded-2xl font-black text-lg shadow-2xl shadow-gray-900/30 hover:scale-105 active:scale-95 transition-all flex items-center gap-3">
            無料で始める
