    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <button
                    onClick={() => openModal()}
                    className="px-5 py-2.5 text-white font-bold rounded-xl transition-all shadow-lg shadow-purple-500/25 flex items-center gap-2 max-w-max hover:opacity-90 active:scale-95"
            ...
            {projects.length === 0 ? (
                <div className="bg-card border text-center py-20 border-card-border rounded-2xl shadow-sm">
                    ...
                    <p className="text-muted-text/80 text-sm">上のボタンをクリックして最初のプロジェクトを作成してください。</p>
                </div>
            ) : (
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in">
                    <form onSubmit={handleSave} className="bg-card rounded-2xl p-8 w-full max-w-4xl shadow-2xl animate-in zoom-in-95 overflow-hidden flex flex-col max-h-[90vh]">
                        ...
                        <div className="flex-1 overflow-y-auto pr-2 -mr-2 scrollbar-thin space-y-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="md:col-span-1">
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">プロジェクト名 <span className="text-red-500">*</span></label>
                                        <input required type="text" value={name} onChange={e=>setName(e.target.value)} className="w-full bg-surface border border-card-border rounded-lg px-4 py-2 focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 outline-none transition-all" placeholder="プロジェクト名" />
                                    </div>
                                    <div className="md:col-span-1">
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">目的</label>
                                        <select
                                        ...
                                        {(objective === '' || !PURPOSE_OPTIONS.some(o => o.value === objective) || PURPOSE_OPTIONS.find(o => o.value === objective)?.value === 'custom') && (
                                            <input
                                                ...
                                                placeholder="カスタムの目的を入力"
                                            />
                                        )}
                                    </div>
                                    <div className="md:col-span-2">
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">プロジェクト説明 <span className="text-red-500">*</span></label>
                                        <textarea required value={description} onChange={e=>setDescription(e.target.value)} className="w-full bg-surface border border-card-border rounded-lg px-4 py-2 min-h-[80px] focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 outline-none transition-all" placeholder="プロジェクトの説明" />
                                    </div>
                                    <div className="md:col-span-2">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">年齢層 <span className="text-red-500">*</span></label>
                                        <input required type="text" value={ageRange} onChange={e=>setAgeRange(e.target.value)} className="w-full bg-surface border border-card-border rounded-lg px-4 py-2 focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 outline-none transition-all" placeholder="例: 18-24" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">性別 <span className="text-muted-text/80 text-[10px] font-normal ml-1">任意</span></label>
                                        <input type="text" value={gender} onChange={e=>setGender(e.target.value)} className="w-full bg-surface border border-card-border rounded-lg px-4 py-2 focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 outline-none transition-all" placeholder="性別" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">地域 <span className="text-muted-text/80 text-[10px] font-normal ml-1">任意</span></label>
                                        <input type="text" value={location} onChange={e=>setLocation(e.target.value)} className="w-full bg-surface border border-card-border rounded-lg px-4 py-2 focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 outline-none transition-all" placeholder="地域" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">職業 <span className="text-muted-text/80 text-[10px] font-normal ml-1">任意</span></label>
                                        <input type="text" value={profession} onChange={e=>setProfession(e.target.value)} className="w-full bg-surface border border-card-border rounded-lg px-4 py-2 focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 outline-none transition-all" placeholder="職業" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="md:col-span-1">
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">トーン＆スタイル</label>
                                    ...
                                    <div className="md:col-span-2">
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">執筆スタイル <span className="text-muted-text/80 text-[10px] font-normal ml-1">任意</span></label>
                                        <input type="text" value={writingStyleNotes} onChange={e=>setWritingStyleNotes(e.target.value)} className="w-full bg-surface border border-card-border rounded-lg px-4 py-2 focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 outline-none transition-all" placeholder="執筆スタイル" />
                                    </div>
                                    <div className="md:col-span-2">
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">参考キャプション (2–3サンプル) <span className="text-muted-text/80 text-[10px] font-normal ml-1">任意</span></label>
                                        <textarea value={exampleCaptions} onChange={e=>setExampleCaptions(e.target.value)} className="w-full bg-surface border border-card-border rounded-lg px-4 py-2 min-h-[100px] focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 outline-none transition-all" placeholder="参考キャプション" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-2 text-foreground font-bold border-b border-card-border pb-2">
                                    ...
                                    <span>投稿プラン <span className="text-muted-text/80 text-[10px] font-normal ml-2">すべて任意</span></span>
                                </div>
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div>
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">投稿頻度</label>
                                    ...
                                    <div>
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">推奨投稿時間</label>
                                        <input
                                            type="time"
                                    ...
                                    <div>
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">キャンペーン期間</label>
                                        <input type="text" value={campaignDuration} onChange={e=>setCampaignDuration(e.target.value)} className="w-full bg-surface border border-card-border rounded-lg px-4 py-2 focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 outline-none transition-all" placeholder="キャンペーン期間" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="md:col-span-2">
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">推奨CTA</label>
                                    ...
                                    <div>
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">NGワード</label>
                                        <input type="text" value={wordsToAvoid} onChange={e=>setWordsToAvoid(e.target.value)} className="w-full bg-surface border border-card-border rounded-lg px-4 py-2 focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 outline-none transition-all" placeholder="NGワード" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">トーンの制限事項</label>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">カスタムプロンプトの指示</label>
                                        <textarea value={customPromptNotes} onChange={e=>setCustomPromptNotes(e.target.value)} className="w-full bg-surface border border-card-border rounded-lg px-4 py-2 min-h-[80px] focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 outline-none transition-all" placeholder="カスタムプロンプトの指示" />
                                    </div>
                                    <div>
                                        <label className="block text-sm font-bold text-foreground/80 mb-1">キャンペーン固有の指示</label>
                                        <textarea value={campaignSpecificInstructions} onChange={e=>setCampaignSpecificInstructions(e.target.value)} className="w-full bg-surface border border-card-border rounded-lg px-4 py-2 min-h-[80px] focus:ring-2 focus:ring-gray-900/10 focus:border-gray-400 outline-none transition-all" placeholder="キャンペーン固有の指示" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="flex items-center justify-end gap-3 mt-8 pt-4 border-t border-card-border shrink-0">
                            <button type="button" onClick={closeModal} className="px-4 py-2 text-sm font-bold text-muted-text hover:bg-surface dark:hover:bg-surface/80 rounded-xl transition-colors">キャンセル</button>
            ...
            {viewingProject && (
                <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-in fade-in">
                    <div className="bg-card rounded-2xl p-8 w-full max-w-2xl shadow-2xl animate-in zoom-in-95 overflow-hidden flex flex-col max-h-[90vh]">
                        <div className="flex items-center justify-between mb-6 shrink-0">
                        ...
                        <div className="flex-1 overflow-y-auto pr-2 -mr-2 scrollbar-thin space-y-6">
                            {viewingProject.description && (
                                <div>
                                    <h3 className="text-sm font-bold text-muted-text/80 uppercase tracking-wider mb-2">プロジェクト説明</h3>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                {viewingProject.toneStyle && (
                                    <div>
                                        <h3 className="text-xs font-bold text-muted-text/80 uppercase tracking-wider mb-1">トーン＆スタイル</h3>
                            ...
                            {(viewingProject.ageRange || viewingProject.gender || viewingProject.location || viewingProject.profession) && (
                                <div>
                                    <h3 className="text-sm font-bold text-muted-text/80 uppercase tracking-wider mb-2 border-b border-card-border pb-2">ターゲット層</h3>
                                    <div className="grid grid-cols-2 gap-4 mt-3">
                                        {viewingProject.ageRange && <div><span className="text-xs text-muted-text block mb-0.5">年齢層</span><span className="text-sm font-semibold text-foreground">{viewingProject.ageRange}</span></div>}
                                        {viewingProject.gender && <div><span className="text-xs text-muted-text block mb-0.5">性別</span><span className="text-sm font-semibold text-foreground">{viewingProject.gender}</span></div>}
                                        {viewingProject.location && <div><span className="text-xs text-muted-text block mb-0.5">地域</span><span className="text-sm font-semibold text-foreground">{viewingProject.location}</span></div>}
                                        {viewingProject.profession && <div><span className="text-xs text-muted-text block mb-0.5">職業</span><span className="text-sm font-semibold text-foreground">{viewingProject.profession}</span></div>}
                                    </div>
                                </div>
                            )}
                            ...
                            {(viewingProject.writingStyleNotes || viewingProject.exampleCaptions) && (
                                <div>
                                    <h3 className="text-sm font-bold text-muted-text/80 uppercase tracking-wider mb-2 border-b border-card-border pb-2">ブランドボイス</h3>
                                    <div className="space-y-3 mt-3">
                                        {viewingProject.writingStyleNotes && (
                                            <div>
                                                <span className="text-xs text-muted-text block mb-0.5">執筆スタイル</span>
                                                <p className="text-sm font-semibold text-foreground">{viewingProject.writingStyleNotes}</p>
                                            </div>
                                        )}
                                        {viewingProject.exampleCaptions && (
                                            <div>
                                                <span className="text-xs text-muted-text block mb-0.5">参考キャプション</span>
                            ...
                            {(viewingProject.postingFrequency || viewingProject.preferredTimeSlots || viewingProject.campaignDuration) && (
                                <div>
                                    <h3 className="text-sm font-bold text-muted-text/80 uppercase tracking-wider mb-2 border-b border-card-border pb-2">投稿プラン</h3>
                                    <div className="grid grid-cols-2 gap-4 mt-3">
                                        {viewingProject.postingFrequency && (
                                            <div>
                                                <span className="text-xs text-muted-text block mb-0.5">投稿頻度</span>
                                        ...
                                        {viewingProject.preferredTimeSlots && (
                                            <div>
                                                <span className="text-xs text-muted-text block mb-0.5">推奨投稿時間</span>
                                        ...
                                        {viewingProject.campaignDuration && (
                                            <div className="col-span-2">
                                                <span className="text-xs text-muted-text block mb-0.5">キャンペーン期間</span>
                            ...
                            {(viewingProject.preferredCtaTypes || viewingProject.wordsToAvoid || viewingProject.toneRestrictions) && (
                                <div>
                                    <h3 className="text-sm font-bold text-muted-text/80 uppercase tracking-wider mb-2 border-b border-card-border pb-2">CTAと制限事項</h3>
                                    <div className="space-y-3 mt-3">
                                        {viewingProject.preferredCtaTypes && (
                                            <div>
                                                <span className="text-xs text-muted-text block mb-0.5">推奨CTA</span>
                                        ...
                                        {viewingProject.wordsToAvoid && (
                                            <div>
                                                <span className="text-xs text-muted-text block mb-0.5">NGワード</span>
                                                <p className="text-sm font-semibold text-red-700">{viewingProject.wordsToAvoid}</p>
                                            </div>
                                        )}
                                        {viewingProject.toneRestrictions && (
                                            <div>
                                                <span className="text-xs text-muted-text block mb-0.5">トーン制限</span>
                            ...
                            {(viewingProject.customPromptNotes || viewingProject.campaignSpecificInstructions) && (
                                <div>
                                    <h3 className="text-sm font-bold text-muted-text/80 uppercase tracking-wider mb-2 border-b border-card-border pb-2">追加の指示</h3>
                                    <div className="space-y-3 mt-3">
                                        {viewingProject.customPromptNotes && (
                                            <div>
                                                <span className="text-xs text-muted-text block mb-0.5">カスタムプロンプト指示</span>
                                        ...
                                        {viewingProject.campaignSpecificInstructions && (
                                            <div>
                                                <span className="text-xs text-muted-text block mb-0.5">キャンペーン固有の指示</span>
